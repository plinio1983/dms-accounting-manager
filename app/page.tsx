  ...
  return <div className="grid dashboard-grid">
    ...
    <div className="card dashboard-annual-card">
      ...
      <div className="annual-kpi-grid annual-totals-grid">
        ...
        <div className="kpi-box kpi-expense"><div className="kpi-label">Spese anno</div><div className={moneyTone(report.totals.speseTotali, 'kpi-value')}>{euro(report.totals.speseTotali)}</div><p className="kpi-help">Totale delle uscite registrate nell’anno fiscale selezionato.</p></div>
